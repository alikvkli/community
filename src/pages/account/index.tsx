...
export default function Account() {
    ...
    return (
        <PublicLayout>
            <section className="flex items-center justify-center w-full mt-6">
                <div className="flex flex-col items-center justify-center gap-4">
                    <div className="relative">
                        <img src={isCustomer ? customerImage : providerImage} className="w-20 h-20 rounded-full" alt={""}/>
                            ...
                            <>
                                ...
                                <div className="flex items-center gap-2 mt-3">
                                    <div className="flex items-center gap-[5.5px]">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1.74854 6.67523L6.07604 5.96023L7.93937 1.99023L9.95687 5.8844L14.3085 6.43023L11.2285 9.5519L12.0535 13.8594L8.1327 11.8944L4.29187 14.0102L4.94854 9.6744L1.74854 6.67523Z" fill="#00697C" stroke="#00697C" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
            ...
            <section className="flex flex-col p-4 mb-28">
