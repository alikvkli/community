...
export default function ProviderProfile({ isOpen, setIsOpen }: { isOpen: boolean, setIsOpen: (isOpen: boolean) => void }) {
                ...
                <div className="flex flex-col mb-[73px] px-4 pb-4">
                    <div className="flex items-center justify-center my-6">
                        <label htmlFor="file">
                            <svg width="81" height="80" viewBox="0 0 81 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="58" y="57" width="22" height="22" rx="11" stroke="white" stroke-width="2" />
                                <path d="M75.1459 67.9993H62.8542M69.0001 61.8535V74.1452" stroke="white" stroke-miterlimit="10" stroke-linecap="round" />
                            </svg>
                            <input className="opacity-0 hidden" id="file" type="file" />
                        </label>
                    </div>
                    ...
                    <div className="flex flex-col items-start mt-4">
                        ...
                        <div className="border border-[#7E7E7E] rounded-md p-4 w-full mt-4">
                            ...
                            <div className="flex items-center gap-1 border-b border-[#ebebebe] pb-4 mt-4">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.875 7.12547H16.125M3.375 4.13672H16.125V12.4055C16.125 12.8033 15.967 13.1848 15.6857 13.4661C15.4044 13.7474 15.0228 13.9055 14.625 13.9055H3.375C2.97718 13.9055 2.59564 13.7474 2.31434 13.4661C2.03304 13.1848 1.875 12.8033 1.875 12.4055V5.63672C1.875 5.23889 2.03304 4.85736 2.31434 4.57606C2.59564 4.29475 2.97718 4.13672 3.375 4.13672Z" stroke="#0D0D0D" stroke-miterlimit="10" stroke-linecap="round" />
                                </svg>
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <button type="button" className="flex items-center gap-1 text-vf-red">
                                ...
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.6668 5.16602L8.00016 10.8327L2.3335 5.16602" stroke="#E60000" stroke-miterlimit="10" stroke-linecap="round" />
                                </svg>
